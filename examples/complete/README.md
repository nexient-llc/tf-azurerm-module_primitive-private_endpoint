...
| <a name="module_acr"></a> [acr](#module\_acr) | git@github.com:nexient-llc/tf-azurerm-module_primitive-container_registry.git | feature/network-rules |
...
| <a name="module_vnet_link"></a> [vnet\_link](#module\_vnet\_link) | git@github.com:nexient-llc/tf-azurerm-module_primitive-private_dns_vnet_link.git | feature/init |
